  ...
  switch (true) {
    ...
    case pLow.includes("television series") ||
      ((pLow.includes("television") ||
        pLow.includes("drama") ||
        document.querySelector("#catlinks").innerText.includes("television")) &&
...
var introParagraph = document.querySelector(".infobox")
  ...
  : document.querySelector("div.mw-parser-output > p:nth-child(2)").textContent;
...
for (key in media.infobox) {
  ...
  switch (key) {
    ...
    case "Composer":
      ...
      answer = `${capitalizeFirstLetter(fullTitle)}${possessive} music ${tense(
        "is"
      )} composed by ${chainAnswer(infobox[key])}.`;
      break;
    case "Country":
      questions = {
